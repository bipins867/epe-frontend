        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ml-auto">
              ...
              <Dropdown show={showDropdown} onToggle={toggleDropdown} className="login-dropdown">
                <Button
                ...
                <Dropdown.Menu align="end">
                  ...
                  <div className="dropdown-auth-links">
                    <span>Personal</span> <span className="auth-options">|</span>
