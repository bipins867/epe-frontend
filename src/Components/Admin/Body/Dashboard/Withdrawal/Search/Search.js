...
import { FaSearch, FaLock } from "react-icons/fa"; // Import lock icon
import "./Search.css";
      ...
      <Card className="shadow-sm">
        <Card.Body>
          <Row className="d-flex justify-content-between align-items-center mb-4">
            ...
            {/* Lock All Withdrawal Requests Button */}
            <Col md={3} className="d-flex justify-content-end">
              <Button
                variant="danger" // Red color for lock (security-related action)
                className="lock-withdrawal-requests-btn"
                onClick={() => alert("Locking All Withdrawal Requests")}
              >
                <FaLock className="me-2" /> Lock All Withdrawal Requests
              </Button>
            </Col>
          </Row>
